...
<body>
	...
	<form id="searchForm" action="supplier.action" method="post">
		<div id="container">
					...
					<div id="box_border">
						...
						<div id="box_bottom">
							<input type="button" value="新增" class="ui_input_btn01 btn_input"
								data-url='<s:url namespace="/" action="supplier_input.action"/>' />
							<input type="button" value="批量删除" class="ui_input_btn01 btn_batch_delete" data-url="<s:url namespace="/" action="supplier_batchDelete.action"/>" />
						</div>
					</div>
				</div>
			</div>
					...
					<table class="table" cellspacing="0" cellpadding="0" width="100%"
						...
						<s:iterator value="#pageResult.result">
							<tr>
								...
								<td>
								<s:url var="inputUrl" namespace="/" action="supplier_input">

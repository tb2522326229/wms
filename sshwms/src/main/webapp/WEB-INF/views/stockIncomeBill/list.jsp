...
<body>
	...
	<form id="searchForm" action="stockIncomeBill.action" method="post">
		<div id="container">
                       ...
                       仓库
						...
						<div id="box_bottom">
							...
							<input type="button" value="新增" class="ui_input_btn01 btn_input"
								data-url='<s:url namespace="/" action="stockIncomeBill_input.action"/>' />
							<input type="button" value="批量删除" class="ui_input_btn01 btn_batch_delete" data-url="<s:url namespace="/" action="stockIncomeBill_batchDelete.action"/>" />
						</div>
					</div>
				</div>
			</div>
						...
						<s:iterator value="#pageResult.result">
							<tr>
								...
								<s:else>
									...
									<s:url var="inputUrl" namespace="/" action="stockIncomeBill_input">
										<s:param name="stockIncomeBill.id" value="id" />
									</s:url> 

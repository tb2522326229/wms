	...
	$(function(){
		...
		$(".btn_submit").click(function(){
			$.each($("#edit_table_body tr"),function(index,item){
				var tr = $(item);
				tr.find("[tag=name]").prop("name", "stockIncomeBill.items[" + index + "].name");
...
<body>
	<s:debug/>
	<form name="editForm" namespace="/" action="stockIncomeBill_saveOrUpdate.action" method="post" id="editForm">
	<s:hidden name="stockIncomeBill.id"/>
	<div id="container">
		<div id="nav_links">
			<span style="color: #1A5CC6;" >仓库入库编辑</span>
			<div id="page_close">
				<a>
			...
			<table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
				...
				<tr>
					...
					<td class="ui_text_lt">
						<s:select list="#depots" name="stockIncomeBill.depot.id" listKey="id" listValue="name" cssClass="ui_select01"/>
					</td>
				</tr>
				<tr>
					<td class="ui_text_rt" width="140">业务时间</td>
					<td class="ui_text_lt">
						<s:date name="stockIncomeBill.vdate" format="yyyy-MM-dd" var="vd"/>
						<s:textfield name="stockIncomeBill.vdate" cssClass="ui_input_txt02" value="%{vd}"/>
					</td>
				</tr>
				<tr>
                    <td></td>

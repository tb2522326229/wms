                        ...
                        <table class="edit_table" cellspacing="0" cellpadding="0" border="0" style="width: auto">
                            ...
                            <tbody id="edit_table_body">
                                <tr>
                                    ...
                                    <td><s:textfield tag="costPrice" name="costPrice" cssClass="ui_input_txt04"/></td>
                                    <td><s:textfield tag="number" name="number" cssClass="ui_input_txt04"/></td>
                            	...
                            	<tfoot>
                            	<tr>
                                	采购总金额：<s:property value="stockIncomeBill.totalAmount"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                	采购总数量：<s:property value="stockIncomeBill.totalNumber"/>
                                </tr>
                                </tfoot>
                        </table>
                    </td>

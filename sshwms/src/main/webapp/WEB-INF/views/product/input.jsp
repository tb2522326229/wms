...
<body>
	<s:debug/>
	<form name="editForm" namespace="/" action="product_saveOrUpdate.action" method="post" id="editForm" enctype="multipart/form-data">
				...
				<tr>
					...
					<td class="ui_text_lt">
						...
						<s:if test="product.id != null">
							<img alt="<s:property value="name"/>" src="<s:property value="product.smailImagePath"/>" class="list_img">
						</s:if>
					</td>
				</tr>
				<tr>

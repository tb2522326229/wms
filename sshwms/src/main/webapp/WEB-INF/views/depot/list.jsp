...
<body>
	...
	<form id="searchForm" action="depot.action" method="post">
		<div id="container">
					...
					<div id="box_border">
						...
						<div id="box_bottom">
							<input type="button" value="新增" class="ui_input_btn01 btn_input"
								data-url='<s:url namespace="/" action="depot_input.action"/>' />
							<input type="button" value="批量删除" class="ui_input_btn01 btn_batch_delete" data-url="<s:url namespace="/" action="depot_batchDelete.action"/>" />
						</div>
					</div>
				</div>
			</div>
					...
					<table class="table" cellspacing="0" cellpadding="0" width="100%"
						...
						<s:iterator value="#pageResult.result">
							<tr>
								...
								<s:url var="inputUrl" namespace="/" action="depot_input">
											<s:param name="depot.id" value="id" />
									</s:url> 
									<a href="<s:property value="#inputUrl"/>">编辑</a> 
									<s:url var="deleteUrl" namespace="/" action="depot_delete">
											<s:param name="depot.id" value="id" />
									</s:url> 

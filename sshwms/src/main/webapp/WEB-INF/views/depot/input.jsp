...
<body>
	<s:debug/>
	<form name="editForm" namespace="/" action="depot_saveOrUpdate.action" method="post" id="editForm">
		...
		<div class="ui_content">
			<table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
				<tr>
					...
					<td class="ui_text_lt">
						<s:textfield name="depot.name" cssClass="ui_input_txt02"/>
					</td>
				</tr>
				<tr>
					<td class="ui_text_rt" width="140">仓库地址</td>
					<td class="ui_text_lt">
						<s:textfield name="depot.address" cssClass="ui_input_txt02"/>
					</td>
				</tr>
